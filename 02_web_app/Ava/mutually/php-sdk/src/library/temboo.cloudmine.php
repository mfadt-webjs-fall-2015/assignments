...
class CloudMine_FileStorage_GetFile_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param bool $value (optional, boolean) Returns the file content as Base64 encoded data when set to "true". This should be set to "true" when returning binary files. Defaults to "false".
     * @return CloudMine_FileStorage_GetFile_Inputs For method chaining.
     */
...
class CloudMine_FileStorage_GetFile_Results extends Temboo_Results
{
     ...
     *
     * @return string The response from CloudMine.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    public function getResponse()
    {
