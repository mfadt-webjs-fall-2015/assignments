 ...
 * @subpackage WolframAlpha
 */
class WolframAlpha_GetSearchResult extends Temboo_Choreography
{
    /**
     * Allows your application to submit a query to Wolfram|Alpha and return only the plain text from the first result pod.
     *
     * @param Temboo_Session $session The session that owns this GetSearchResult Choreo.
     * @return WolframAlpha_GetSearchResult New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/WolframAlpha/GetSearchResult/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this GetSearchResult Choreo.
     *
     * @param WolframAlpha_GetSearchResult_Inputs|array $inputs (optional) Inputs as WolframAlpha_GetSearchResult_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return WolframAlpha_GetSearchResult_Execution New execution object.
    ...
    {
        return new WolframAlpha_GetSearchResult_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetSearchResult Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return WolframAlpha_GetSearchResult_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new WolframAlpha_GetSearchResult_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the GetSearchResult Choreo.
 *
 * @package Temboo
 * @subpackage WolframAlpha
 */
class WolframAlpha_GetSearchResult_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the GetSearchResult Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return WolframAlpha_GetSearchResult_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    ...
    /**
     * Set arbitrary input this GetSearchResult input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return WolframAlpha_GetSearchResult_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppID input for this GetSearchResult Choreo.
     *
    ...
    /**
     * Set the value for the Input input for this GetSearchResult Choreo.
     *
    ...
    /**
     * Set the value for the Latitude input for this GetSearchResult Choreo.
     *
    ...
    /**
     * Set the value for the Location input for this GetSearchResult Choreo.
     *
    ...
    /**
     * Set the value for the Longitude input for this GetSearchResult Choreo.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this GetSearchResult Choreo.
     *
    ...
    /**
     * Set the value for the Translation input for this GetSearchResult Choreo.
     *
    ...
    /**
     * Set the value for the Units input for this GetSearchResult Choreo.
     *
...
/**
 * Execution object for the GetSearchResult Choreo.
 *
 * @package Temboo
 * @subpackage WolframAlpha
 */
class WolframAlpha_GetSearchResult_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the GetSearchResult Choreo.
     *
     * @param Temboo_Session $session The session that owns this GetSearchResult execution.
     * @param WolframAlpha_GetSearchResult $choreo The choreography object for this execution.
     * @param WolframAlpha_GetSearchResult_Inputs|array $inputs (optional) Inputs as WolframAlpha_GetSearchResult_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return WolframAlpha_GetSearchResult_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, WolframAlpha_GetSearchResult $choreo, $inputs = array(), $async = false, $store_results = true)
    {
     ...
     *
     * Includes getters appropriate for this GetSearchResult execution.
     *
     * @return WolframAlpha_GetSearchResult_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
    ...
    /**
     * Wraps results in appropriate results class for this GetSearchResult execution.
     *
    ...
    {
        return new WolframAlpha_GetSearchResult_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the GetSearchResult Choreo.
 *
 * @package Temboo
 * @subpackage WolframAlpha
 */
class WolframAlpha_GetSearchResult_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the GetSearchResult Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return WolframAlpha_GetSearchResult_Results New instance.
    ...
    /**
     * Retrieve the value for the "Result" output from this GetSearchResult execution.
     *
     * @return string (string) The plain text result parsed from the Wolfram Alpha response.
