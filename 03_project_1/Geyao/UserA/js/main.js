...
var saveTask = function(){
    ...
    $.get( "http://data.sparkfun.com/input/0lxyEV808msY8r2bVM14?private_key=D6pyroKBKEhEonK16aN9&ciphers=" + encodedString);
...
$(document).ready(function() {
			...
			function updateData(){
				$("data").empty();
				var attention;
		        $.get( "http://data.sparkfun.com/output/2JxAO5vb7biEWpAJ639w/latest.csv", function( data ) {
					var items = [];
					console.log(data);
					items = data.split(",");
