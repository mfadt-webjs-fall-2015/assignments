 ...
 * @subpackage Flickr
 */
class Flickr_Photos_GetInfo extends Temboo_Choreography
{
    /**
     * Retrieves information about a specified photo.
     *
     * @param Temboo_Session $session The session that owns this GetInfo Choreo.
     * @return Flickr_Photos_GetInfo New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/Flickr/Photos/GetInfo/');
    }
     ...
     *
     * @param Flickr_Photos_GetInfo_Inputs|array $inputs (optional) Inputs as Flickr_Photos_GetInfo_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Flickr_Photos_GetInfo_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new Flickr_Photos_GetInfo_Execution($this->session, $this, $inputs, $async, $store_results);
    }
     ...
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Flickr_Photos_GetInfo_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new Flickr_Photos_GetInfo_Inputs($inputs);
    }
}
 ...
 * @subpackage Flickr
 */
class Flickr_Photos_GetInfo_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the GetInfo Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Flickr_Photos_GetInfo_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
     ...
     * @param string $name Input name.
     * @param string $value Input value.
     * @return Flickr_Photos_GetInfo_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the APISecret input for this GetInfo Choreo.
     *
    ...
    /**
     * Set the value for the AccessTokenSecret input for this GetInfo Choreo.
     *
    ...
    /**
     * Set the value for the AccessToken input for this GetInfo Choreo.
     *
    ...
    /**
     * Set the value for the PhotoID input for this GetInfo Choreo.
     *
     * @param int $value (required, integer) The ID of the photo.
     * @return Flickr_Photos_GetInfo_Inputs For method chaining.
     */
    public function setPhotoID($value)
    {
    ...
    /**
     * Set the value for the PhotoSecret input for this GetInfo Choreo.
     *
     * @param string $value (optional, string) The secret for the photo. If the correct secret is passed then permissions checking is skipped, and authenticating with OAuth tokens is not required.
     * @return Flickr_Photos_GetInfo_Inputs For method chaining.
     */
    public function setPhotoSecret($value)
    {
        return $this->set('PhotoSecret', $value);
    }

    /**
     * Set the value for the ResponseFormat input for this GetInfo Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Valid values are: xml and json. Defaults to json.
     * @return Flickr_Photos_GetInfo_Inputs For method chaining.
     */
 ...
 * @subpackage Flickr
 */
class Flickr_Photos_GetInfo_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the GetInfo Choreo.
     *
     * @param Temboo_Session $session The session that owns this GetInfo execution.
     * @param Flickr_Photos_GetInfo $choreo The choreography object for this execution.
     * @param Flickr_Photos_GetInfo_Inputs|array $inputs (optional) Inputs as Flickr_Photos_GetInfo_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Flickr_Photos_GetInfo_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, Flickr_Photos_GetInfo $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     *
     * @return Flickr_Photos_GetInfo_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    protected function wrapResults($outputs)
    {
        return new Flickr_Photos_GetInfo_Results($outputs);
    }
}
 ...
 * @subpackage Flickr
 */
class Flickr_Photos_GetInfo_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the GetInfo Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return Flickr_Photos_GetInfo_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
