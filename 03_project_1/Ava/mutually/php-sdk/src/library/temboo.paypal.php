...
class PayPal_Payments_AcceptPayPalPayment_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param bool $value (conditional, boolean) Set to 1 to indicate that you're testing against the PayPal sandbox instead of production. Set to 0 (the default) when moving to production.
     * @return PayPal_Payments_AcceptPayPalPayment_Inputs For method chaining.
     */
...
class PayPal_OAuth_GetAccessToken_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param bool $value (conditional, boolean) Set to 1 to indicate that you're testing against the PayPal sandbox instead of production. Defaults to 0.
     * @return PayPal_OAuth_GetAccessToken_Inputs For method chaining.
     */
    public function setUseSandbox($value)
    {
 ...
 * @subpackage PayPal
 */
class PayPal_Payments_GetLatestPayment extends Temboo_Choreography
{
    /**
     * Retrieves the latest payment.
     *
     * @param Temboo_Session $session The session that owns this GetLatestPayment Choreo.
     * @return PayPal_Payments_GetLatestPayment New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/PayPal/Payments/GetLatestPayment/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this GetLatestPayment Choreo.
     *
     * @param PayPal_Payments_GetLatestPayment_Inputs|array $inputs (optional) Inputs as PayPal_Payments_GetLatestPayment_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return PayPal_Payments_GetLatestPayment_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new PayPal_Payments_GetLatestPayment_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetLatestPayment Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return PayPal_Payments_GetLatestPayment_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new PayPal_Payments_GetLatestPayment_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the GetLatestPayment Choreo.
 *
 * @package Temboo
 * @subpackage PayPal
 */
class PayPal_Payments_GetLatestPayment_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the GetLatestPayment Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return PayPal_Payments_GetLatestPayment_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this GetLatestPayment input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return PayPal_Payments_GetLatestPayment_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the AccessToken input for this GetLatestPayment Choreo.
     *
     * @param string $value (optional, string) A valid access token retrieved from PayPal. Required unless providing the ClientID and ClientSecret which can be used to generate a new access token.
     * @return PayPal_Payments_GetLatestPayment_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ClientID input for this GetLatestPayment Choreo.
     *
     * @param string $value (conditional, string) The Client ID provided by PayPal. Required unless a valid Access Token is provided.
     * @return PayPal_Payments_GetLatestPayment_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ClientSecret input for this GetLatestPayment Choreo.
     *
     * @param string $value (conditional, string) The Client Secret provided by PayPal. Required unless a valid Access Token is provided.
     * @return PayPal_Payments_GetLatestPayment_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Scope input for this GetLatestPayment Choreo.
     *
     * @param string $value (optional, string) A space delimited list of resource URL endpoints that the token should have access for. This is only used when providing the ClientID and Client Secret in order to generate a new access token.
     * @return PayPal_Payments_GetLatestPayment_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the UseSandbox input for this GetLatestPayment Choreo.
     *
     * @param bool $value (conditional, boolean) Set to 1 to indicate that you're testing against the PayPal sandbox instead of production. Set to 0 (the default) when moving to production.
     * @return PayPal_Payments_GetLatestPayment_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetLatestPayment Choreo.
 *
 * @package Temboo
 * @subpackage PayPal
 */
class PayPal_Payments_GetLatestPayment_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the GetLatestPayment Choreo.
     *
     * @param Temboo_Session $session The session that owns this GetLatestPayment execution.
     * @param PayPal_Payments_GetLatestPayment $choreo The choreography object for this execution.
     * @param PayPal_Payments_GetLatestPayment_Inputs|array $inputs (optional) Inputs as PayPal_Payments_GetLatestPayment_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return PayPal_Payments_GetLatestPayment_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, PayPal_Payments_GetLatestPayment $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this GetLatestPayment execution.
     *
     * @return PayPal_Payments_GetLatestPayment_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this GetLatestPayment execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return PayPal_Payments_GetLatestPayment_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new PayPal_Payments_GetLatestPayment_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the GetLatestPayment Choreo.
 *
 * @package Temboo
 * @subpackage PayPal
 */
class PayPal_Payments_GetLatestPayment_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the GetLatestPayment Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return PayPal_Payments_GetLatestPayment_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Response" output from this GetLatestPayment execution.
     *
     * @return string (json) The response from PayPal.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    ...
    /**
     * Retrieve the value for the "Amount" output from this GetLatestPayment execution.
     *
     * @return float (decimal) The amount of the latest payment.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    ...
    /**
     * Retrieve the value for the "CreateTime" output from this GetLatestPayment execution.
     *
    ...
    /**
     * Retrieve the value for the "NewAccessToken" output from this GetLatestPayment execution.
     *
     * @return string (string) The new access token retrieved from PayPal when providing the Client ID and Client Secret.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    ...
    /**
     * Retrieve the value for the "PaymentID" output from this GetLatestPayment execution.
     *
    ...
    /**
     * Retrieve the value for the "State" output from this GetLatestPayment execution.
     *
