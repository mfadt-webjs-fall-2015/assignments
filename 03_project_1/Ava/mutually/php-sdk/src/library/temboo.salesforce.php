...
class Salesforce_OAuth_InitializeOAuth_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (conditional, string) A space separated list of scope values. Supported values are: api, chatter_api, full, id, refresh_token, visualforce, web. Defaults to: id, api, refresh_token.
     * @return Salesforce_OAuth_InitializeOAuth_Inputs For method chaining.
     */
