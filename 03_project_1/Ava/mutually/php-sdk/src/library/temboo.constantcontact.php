...
class ConstantContact_ListAllContacts_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the NextResults input for this ListAllContacts Choreo.
     *
     * @param string $value (optional, string) The URI returned in the "NextPage" output of this Choreo. This value is used to retrieve the next 50 results.
     * @return ConstantContact_ListAllContacts_Inputs For method chaining.
     */
    public function setNextResults($value)
    {
        return $this->set('NextResults', $value);
    }
...
class ConstantContact_ListAllContacts_Results extends Temboo_Results
{
    ...
    /**
     * Retrieve the value for the "NextPage" output from this ListAllContacts execution.
     *
...
class ConstantContact_SearchContactsByUpdatedSince_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the NextResults input for this SearchContactsByUpdatedSince Choreo.
     *
     * @param string $value (optional, string) The URI returned in the "NextPage" output of this Choreo. This value is used to retrieve the next 50 results.
     * @return ConstantContact_SearchContactsByUpdatedSince_Inputs For method chaining.
     */
...
class ConstantContact_SearchContactsByUpdatedSince_Results extends Temboo_Results
{
    ...
    /**
     * Retrieve the value for the "NextPage" output from this SearchContactsByUpdatedSince execution.
     *
     * @return string (string) A URI used to retrieve the next page of results. If this value is not returned, there are no more results to retrieve. This value can be passed to the "NextResults" input of this Choreo.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
