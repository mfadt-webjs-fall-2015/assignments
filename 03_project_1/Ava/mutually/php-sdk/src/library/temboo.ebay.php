...
class eBay_Trading_AddBasicListing_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (conditional, string) The URL for a picture associated with an item. Multiple URLs can be specified as a comma-separated list.
     * @return eBay_Trading_AddBasicListing_Inputs For method chaining.
     */
     ...
     *
     * @param bool $value (conditional, boolean) Indicates that the request should be made to the sandbox endpoint instead of the production endpoint. Set to 1 to enable sandbox mode.
     * @return eBay_Trading_AddBasicListing_Inputs For method chaining.
     */
...
class eBay_Trading_GetItem_Results extends Temboo_Results
{
    ...
    /**
     * Retrieve the value for the "CurrentPrice" output from this GetItem execution.
     *
     * @return float (decimal) The current price for the item.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    public function getCurrentPrice()
    {
        return $this->get('CurrentPrice');
    }
    /**
     * Retrieve the value for the "DaysLeft" output from this GetItem execution.
     *
     * @return int (integer) The number of days until the auction ends.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    ...
    /**
     * Retrieve the value for the "HoursLeft" output from this GetItem execution.
     *
     * @return int (integer) The number of hours until the auction ends.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    public function getHoursLeft()
    {
        return $this->get('HoursLeft');
    }
    /**
     * Retrieve the value for the "MinutesLeft" output from this GetItem execution.
     *
     * @return int (integer) The number of minutes until the auction ends.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    ...
    /**
     * Retrieve the value for the "SecondsLeft" output from this GetItem execution.
     *
     * @return int (integer) The number of seconds until the auction ends.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    public function getSecondsLeft()
    {
        return $this->get('SecondsLeft');
    }
}
...
class eBay_Trading_ReviseItem_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (optional, string) The URL for a picture associated with an item. Multiple URLs can be specified as a comma-separated list.
     * @return eBay_Trading_ReviseItem_Inputs For method chaining.
     */
    public function setPictureURL($value)
    {
